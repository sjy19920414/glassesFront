<template>
    <section>
        ...
        <el-table
            ...
            style="width: 100%;">
            <el-table-column prop="vipName" :label="$t('vip.vipName')" width="170"></el-table-column>
            <el-table-column prop="vipPhone" :label="$t('vip.vipPhone')" width="120"></el-table-column>
            <el-table-column
                prop="vipBirthTime"
